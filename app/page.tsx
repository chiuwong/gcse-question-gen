  ...
  async function generate() {
    ...
    try {
      const res = await fetch("/api/generate", {
        ...
        body: JSON.stringify({ subject, topic, marks, variant: Math.floor(Math.random() * 100000) }),
      });
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-80 flex-shrink-0">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4 lg:sticky lg:top-6">
          ...
          <div className="flex-1 space-y-6">
            ...
            {!generated && !generating && (
              <div className="bg-white rounded-2xl border border-dashed border-slate-300 p-12 text-center text-slate-400">
                ...
                <p className="font-medium">Pick a subject and topic, then click Generate</p>
              </div>
            )}

            {generating && (
              <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center text-slate-400">
                <p className="animate-pulse font-medium">Generating your question…</p>
              </div>
            )}
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm text-black focus:outline-none focus:ring-2 focus:ring-slate-400 resize-y"
                  />
                </div>
